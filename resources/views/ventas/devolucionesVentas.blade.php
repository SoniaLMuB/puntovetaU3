...
@section('contenido')
            ...
            <div class="flex-none w-full max-w-full px-3">
                <div
                    ...
                    <div class="my-4 space-x-2 y-2" style="display: flex; justify-content:end; margin-right: 20px;">
                        ...
                        <button onclick="exportarXLSX('Devoluciones')"
                                            ...
                                            <td
                                                ...
                                                <button class="btn-delete" data-id="{{ $data->id }}">
                                                    <form id="delete-form-{{ $data->id }}"
                                                        action="{{ route('devoluciones.delete', $data->id) }}"
    ...
    <script>
        $('.btn-delete').on('click', function(e) {
            ...
            Swal.fire({
                title: "¿Estás seguro de eliminar la devolución?",
                text: "Los cambios no se recuperarán!",
                icon: "warning",
