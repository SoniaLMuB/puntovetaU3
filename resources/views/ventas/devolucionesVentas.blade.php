                    ...
                    <div class="p-4 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <div class="flex flex-wrap -mx-3">
                          <div class="flex items-center flex-none w-1/2 max-w-full px-3">
                            <h4 class="mb-0 dark:text-white">Lista de devoluciones</h4>
                          </div>
                          <div class="flex-none w-1/2 max-w-full px-3 text-right">
                            <a href="#" class="inline-block px-5 py-2.5 font-bold leading-normal text-center text-white align-middle transition-all  rounded-lg cursor-pointer text-sm ease-in shadow-md bg-150 bg-blue-500  hover:shadow-xs hover:-translate-y-px tracking-tight-rem bg-x-25" href="javascript:;"> <i class="fas fa-plus" aria-hidden="true"> </i>&nbsp;&nbsp;Añadir nueva devolución</a>
                          </div>
                        </div>
                      </div>
                    <br>
                        ...
                        <div class="p-0 overflow-x-auto">
                            <table id="table1"
                                ...
                                <tbody>
                                    ...
                                    <td
                                        class="p-2 text-center align-middle bg-transparent border-b dark:border-white/40 
