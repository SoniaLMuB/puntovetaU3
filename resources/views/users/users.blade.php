            ...
            <div class="flex-none w-full max-w-full px-3">
                <div
                    ...
                    <div class="my-4 space-x-2 y-2" style="display: flex; justify-content:end; margin-right: 20px;">
                        <button onclick="exportToPDF('usuarios')"
                        ...
                        <button onclick="exportarXLSX('usuarios')"
                            class="inline-block px-5 py-2.5 font-bold leading-normal text-center text-white align-middle transition-all  rounded-lg cursor-pointer text-sm ease-in shadow-md bg-150 bg-blue-500  hover:shadow-xs hover:-translate-y-px tracking-tight-rem bg-x-25">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                                ...
                                                <div class="flex px-2 py-1">
                                                    <div>
                                                        @if ($usuario->image == null)
                                                            <img src="https://imgs.search.brave.com/i15y3X6nfMw2luigHIiA8xzLtVCUFNH92UHTsCu5Gcg/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9jZG4u/aWNvbi1pY29ucy5j/b20vaWNvbnMyLzgy/Ny9QTkcvNTEyL3Vz/ZXJfaWNvbi1pY29u/cy5jb21fNjY1NDYu/cG5n"
                                        ...
                                        bg-x-25"
                                            ...
                                            <td
                                                ...
                                                <button  class="btn-delete" data-id="{{ $usuario->id }}"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                        fill="currentColor" class="bi bi-trash3-fill red"
                                                        viewBox="0 0 16 16">
                                                        <path
