                    ...
                    <div class="p-4 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <div class="flex flex-wrap -mx-3">
                            <div class="flex items-center flex-none w-1/2 max-w-full px-3">
                                <h4 class="mb-0 dark:text-white">Añadir Sub categoría</h4>
                            </div>
                        </div>
                    </div>
                                ...
                                <div
                                    ...
                                    <div class="flex-auto p-6">
                                        ...
                                        <form action="{{ route('subCategorias.update') }}" method="POST" novalidate>
                                            @csrf
                                            <input type="hidden" name="id" id="" value="{{$subcategoria->id}}">
                                            <div class="flex flex-wrap -mx-3">
                                                ...
                                                <div class="w-full max-w-full px-3 shrink-0 md:w-full md:flex-0">
                                                    <div class="mb-4">
                                                        ...
                                                        @enderror
                                                        <input type="text" placeholder="Ingrese código de sub categoria" value="{{$subcategoria->codigo}}"
                                                            name="codigo"
                                                            class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                                    </div>
                                                </div>
                                                <div class="w-full max-w-full px-3 shrink-0 md:w-full md:flex-0">
                                                    <div class="mb-4">
                                                        ...
                                                        @enderror
                                                        <input type="text" name="descripcion" value="{{$subcategoria->descripcion}}"
