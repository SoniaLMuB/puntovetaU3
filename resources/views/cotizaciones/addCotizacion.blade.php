                    ...
                    <div class="p-4 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <div class="flex flex-wrap -mx-3">
                            <div class="flex items-center flex-none w-1/2 max-w-full px-3">
                                <h4 class="mb-0 dark:text-white">Añadir cotización</h4>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="flex-auto p-6">
                                        ...
                                        <form action="{{ route('productos.create') }}" method="POST" novalidate>
                                            ...
                                            <div class="flex flex-wrap -mx-3">
                                                ...
                                                <div class="w-full max-w-full d-flex justify-end px-3 shrink-0 md:w-8/12 md:flex-0">
                                                    <div class="mb-4">
                                                        <h3
                                                    ...
                                                    <div class="flex-none w-2/2 max-w-full text-right">
                                                        <button type="submit"
                                                            ...
                                                            href="javascript:;"> <i class="fas fa-plus"
                                                                aria-hidden="true"> </i>&nbsp;&nbsp;Registrar cotización
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
