                    ...
                    <div class="p-4 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <div class="flex flex-wrap -mx-3">
                            <div class="flex items-center flex-none w-1/2 max-w-full px-3">
                                <h4 class="mb-0 dark:text-white">Editar marca</h4>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:w-7/12 lg:flex-none">
                                <div
                                    ...
                                    <div class="flex-auto p-6">
                                        ...
                                        <form action="{{route('marcas.update')}}" method="POST" novalidate>
                                            @csrf
                                            <input type="hidden" name="id" id="id_marca" value="{{$marca->id}}">
                                            <div class="flex flex-wrap -mx-3">
                                                ...
                                                <div class="w-full max-w-full px-3 shrink-0 md:w-full md:flex-0">
                                                    <div class="mb-4">
                                                        ...
                                                        @enderror
                                                            <input type="text" name="descripcion" value="{{$marca->descripcion}}"
